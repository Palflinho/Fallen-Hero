...
with (obj_enemy_parent) {
    ...
    if (!_already_hit && (!fh_untargetable || (fh_air && instance_exists(other.owner) && other.owner.element_affinity == "water")) && point_distance(x, y, other.x, other.y) <= body_radius + other.body_radius) {
