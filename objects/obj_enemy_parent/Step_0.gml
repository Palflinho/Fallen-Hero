...
if (hp <= 0) {
    ...
    if (object_index == obj_boss) {
        ...
        _g_ret.gate_label = tr("[RETORNO] Vila Subterranea (100% Ouro)");
        ...
        _g_adv.gate_label = tr("[AVANCO] Templo do Fogo (Cura 40% HP)");
        _g_adv.gate_colour = make_colour_rgb(255, 110, 60);

        with (obj_hud) {
            room_banner_title = tr("* GENERAL GLACIAL DERROTADO! *");
            room_banner_sub = tr("Escolha seu destino nos portais da arena!");
        ...
        _g_adv.reward_type = "heal";
        _g_adv.gate_label = tr("[AVANCO] Ruinas dos Ventos (Cura 40% HP)");
        _g_adv.gate_colour = make_colour_rgb(180, 240, 255);

        with (obj_hud) {
            room_banner_title = tr("* GENERAL MAGMA DERROTADO! *");
            room_banner_sub = tr("Escolha seu destino nos portais da arena!");
            room_banner_color = c_yellow;
            room_banner_timer = 3.5;
            room_banner_flash = 0.45;
        ...
        _g_adv.reward_type = "heal";
        _g_adv.gate_label = tr("[AVANCO] Santuario da Terra (Cura 40% HP)");
        _g_adv.gate_colour = make_colour_rgb(120, 220, 100);

        with (obj_hud) {
            room_banner_title = tr("* GENERAL ZEPHYRUS DERROTADO! *");
            room_banner_sub = tr("Escolha seu destino nos portais da arena!");
            room_banner_color = c_yellow;
            room_banner_timer = 3.5;
            room_banner_flash = 0.45;
        ...
        _g_adv.reward_type = "heal";
        _g_adv.gate_label = tr("[ORBITA] Santuario Humano (Templo 5)");
        _g_adv.gate_colour = make_colour_rgb(255, 230, 120);

        with (obj_hud) {
            room_banner_title = tr("* TITA MONOLITO DERROTADO! *");
            room_banner_sub = tr("As 4 Essencias foram reunidas!");
            room_banner_color = c_yellow;
            room_banner_timer = 3.5;
            room_banner_flash = 0.45;
        }
