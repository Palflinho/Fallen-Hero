...
with (obj_enemy_parent) {
    ...
    if (!_already_hit && (!fh_untargetable || fh_mist_cut) && point_distance(x, y, other.x, other.y) <= body_radius + other.body_radius && !fh_line_intersects_wall(other.x, other.y, x, y)) {
